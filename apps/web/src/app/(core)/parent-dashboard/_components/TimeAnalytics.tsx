      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-lg bg-card border border-black/30 p-4 shadow-warm-lg">
          ...
          <div className="flex items-center justify-between mt-3">
            <span className="text-xs text-muted-foreground">since joining</span>
        ...
        <div className="rounded-lg bg-card border border-black/30 p-4 shadow-warm-lg">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            across {activityRate.daysRead} reading days
          </p>
        </div>
      </div>
          ...
          <TableBody>
            {filteredTimeEntries.length === 0 ? (
              <TableRow>
                ...
                >
                  No reading activity yet. Start playing to see reading
                  statistics!
                </TableCell>
              </TableRow>
            ) : (
